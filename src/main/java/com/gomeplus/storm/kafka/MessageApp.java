...
//        spoutConf.zkServers = Arrays.asList("bj02-im-hadoop01,bj02-im-hadoop02,bj02-im-hadoop03,bj02-im-hadoop04,bj02-im-hadoop05".split(",")); //pre
...
//        spoutConf.zkServers = Arrays.asList("bj01-im-data01,bj01-im-data02,bj01-im-data03".split(",")); //dev        
		...
		FileNameFormat fileNameFormat = new DefaultFileNameFormat().withPath("/tmp/gomeplus");//文件名策略,初始化流的输出地址
//		FileRotationPolicy rotationPolicy = new TimedRotationPolicy(1.0f, TimeUnit.DAYS); // TimeRotationPolicy
		...
		HdfsBolt messageBolt = new HdfsBolt()
				...
				.withDirPrex("/user/hive1.2.1/warehouse/gomeplus.db/message_log/logday=") //输出文件的地址
		...
		HdfsBolt loginBolt = new HdfsBolt()
                ...
                .withDirPrex("/user/hive1.2.1/warehouse/gomeplus.db/login_log/logday=")
                .withSplitField("loginTime")//loginTime  //logtime old
                .witHdfsConfigure(hdfsConfig);
		...
		HdfsBolt groupBolt = new HdfsBolt()
		        ...
		        .withRotationPolicy(rotationPolicy)
		        .withSyncPolicy(syncPolicy)
		        .withDirPrex("/user/hive1.2.1/warehouse/gomeplus.db/group_log/logday=")
		...
		HdfsBolt fileBolt = new HdfsBolt()
		        ...
		        .withRotationPolicy(rotationPolicy)
		        .withSyncPolicy(syncPolicy)
		        .withDirPrex("/user/hive1.2.1/warehouse/gomeplus.db/file_log/logday=")
		        .withSplitField("operationTime")
		        .witHdfsConfigure(hdfsConfig);
...
//		props.put("bootstrap.servers", "bj01-im-data01:9092,bj01-im-data02:9092,bj01-im-data03:9092");
//		props.put("bootstrap.servers", "bj02-im-hadoop01:9092,bj02-im-hadoop02:9092,bj02-im-hadoop03:9092,bj02-im-hadoop04:9092,bj02-im-hadoop05:9092");
